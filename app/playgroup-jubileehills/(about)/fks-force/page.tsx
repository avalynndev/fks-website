    ...
    <div className="max-w-6xl mx-auto">
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="gap-8 items-center border border-border/50 bg-card/30 p-8 shadow-lg rounded-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center border border-border/50 bg-card/30 p-8 shadow-lg rounded-3xl">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Over the years, this belief has been reflected in the parents’
                unflinching faith in the FKS team. We have parents walk with us
                in their child’s learning journey as volunteers, mentors and
                friends. This has helped us build a coherent world of common
                understanding, philosophies and foundation for ‘our’ children.
              </p>
            </div>
            <div className="relative w-full h-80 rounded-2xl overflow-hidden order-first lg:order-last">
              <FadeImage
