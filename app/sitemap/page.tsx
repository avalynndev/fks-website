  ...
  const sitemapStructure = {
    ...
    mainCampus: {
      ...
      learning: [
        {
          ...
          path: "/main-campus/board-and-curriculum",
        },
      ...
      beyond: [
        ...
        { name: "Field Trips", path: "/main-campus/field-trips" },
        {
          ...
          path: "/main-campus/events-and-festivals",
        },
      ],
      other: [
    ...
    playgroupJubileehills: {
      about: [
        ...
        {
          name: "Mission & Vision",
          path: "/playgroup-jubileehills/mission-and-vision",
        },
      ...
      learning: [
        {
          ...
          path: "/playgroup-jubileehills/thematic-learning",
        },
        {
          name: "Learning Framework",
          path: "/playgroup-jubileehills/learning-framework",
        },
        {
          name: "Learning Activities",
          path: "/playgroup-jubileehills/learning-activities",
        },
      ],
      beyond: [
        ...
        {
          name: "Events & Festivals",
          path: "/playgroup-jubileehills/events-and-festivals",
        },
      ],
      other: [
    ...
    playgroupNarsingi: {
      about: [
        ...
        {
          name: "Mission & Vision",
          path: "/playgroup-narsingi/mission-and-vision",
        },
      ...
      learning: [
        {
          name: "Thematic Learning",
          path: "/playgroup-narsingi/thematic-learning",
        },
        {
          name: "Learning Framework",
          path: "/playgroup-narsingi/learning-framework",
        },
        {
          name: "Learning Activities",
          path: "/playgroup-narsingi/learning-activities",
        },
      ],
      beyond: [
        ...
        {
          name: "Events & Festivals",
          path: "/playgroup-narsingi/events-and-festivals",
        },
      ],
      other: [
          ...
          <div className="bg-card border rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold mb-2 text-primary">Learning</h3>
                <ul className="space-y-1">
                  {sitemapStructure.playgroupJubileehills.learning.map(
                    (page) => (
                      <li key={page.path}>
                        <Link
                          href={page.path}
