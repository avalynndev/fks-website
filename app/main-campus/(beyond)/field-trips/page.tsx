          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center border border-border/50 bg-card/30 p-8 shadow-lg rounded-3xl">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold">
                FIELD & OUT OF STATION TRIPS
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                Stepping beyond the boundaries of the school with a purpose in
                mind works wonders on young children. While improving
                interpersonal relationships with peers, it also instils
                awareness, endurance, patience and grit, which can never be
                taught in the confines of a classroom.
                <br /> <br />
                This world is only as creepy as we make it – so at FKS our motto
                is to dare to explore our world and its wonders – and in the
                process – find ourselves!
              </p>
            </div>
