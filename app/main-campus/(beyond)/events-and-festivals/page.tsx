        ...
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center border border-border/50 bg-card/30 p-8 shadow-lg rounded-3xl">
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Events are an integral feature of the FKS philosophy to build
                ...
                <br /> <br />
                Events instill a sense of ownership and appreciation for all.
                Students hence realize the importance of a team, imbibe a sense
                of dignity and appreciate the power of hard work.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center border border-border/50 bg-card/30 p-8 shadow-lg rounded-3xl">
            <div className="space-y-6">
              <p className="text-muted-foreground leading-relaxed">
                ...
                conceptualized and hosted many events, such as, fairs,
                exhibitions, shows etc. Each year, the surplus from these shows
                support various social and charitable initiatives identified by
                the students.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center border border-border/50 bg-card/30 p-8 shadow-lg rounded-3xl">
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                At FKS we celebrate life in all its nuances. No matter what the
                religion, caste, creed or economic background, we encourage the
                feeling of oneness of humanity and use every opportunity to
                bring out the joy of childhood and innocence.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Festivals are a special and most beautiful way to demonstrate
                ‘Unity in Diversity’ to our children – a boon of a culturally
                rich and vibrant country called India! FKS is a world beyond
                religions and faith and we welcome each festival with zeal and
                day-long celebrations with activities, programs and lots of good
                food!
              </p>
            </div>
          </div>
