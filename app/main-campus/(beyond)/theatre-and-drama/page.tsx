...
export default function HeroSection() {
  const performance = [
    ...
    {
      name: "Folk Dance", icon: "/folk-dance.png" },
    {
      name: "Classical Dance", icon: "/classical-dance.png" },
    {
      name: "Drums",
      icon: "/drums.png",
    },
